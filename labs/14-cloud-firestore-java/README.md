...
![img.png](images/firebase-create-project.png)

Geben Sie an, dass Sie das Projekt mit einem bestehenden GCP-Projekt verbinden
möchten.

![firebase-add](images/firebase-add-to-existing-project.png)
...
![img.png](images/firebase-select-project-name.png)
...
![img.png](images/firebase-console.png)

Wechseln Sie im Menü links auf "Firestore Database"

![img.png](images/firestore-database.png)

Legen Sie eine neue Datenbank "(default)" an und wählen Sie "europe" als
Location.

![img.png](images/firestore-create-database.png)
